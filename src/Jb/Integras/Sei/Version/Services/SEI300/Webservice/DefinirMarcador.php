...
class DefinirMarcador extends IntegrasSEI300 implements IntegrasServiceInterface, ExtractInterface
{

    private $idUnidade = null;

    private $definicoes = null;
    ...
    private function loadParameters(array $args)
    {
        ...
        if (!isset($args[1])) {
            IntegrasServicesArgumentException::argumentRequired('definicoes');
        }

        $this->idUnidade = isset($args[0]) ? $args[0] : null;
        $this->definicoes = isset($args[1]) ? $args[1] : null;
    }
