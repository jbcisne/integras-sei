...
class SobrestarProcesso extends IntegrasSEI300 implements IntegrasServiceInterface, ExtractInterface
{
    ...
    private $protocoloProcedimentoVinculado = null;
    ...
    private function loadParameters(array $args)
    {
        ...
        if (!isset($args[2])) {
            IntegrasServicesArgumentException::argumentRequired('protocoloProcedimentoVinculado');
        }
        ...
        $this->protocoloProcedimentoVinculado = isset($args[2]) ? $args[2] : null;
        ...
        try {
            return $this->resource->__soapCall(
                ...
                array(
                    ...
                    'ProtocoloProcedimentoVinculado' => $this->protocoloProcedimentoVinculado,
                    'Motivo' => $this->motivo
                )
            );
        } catch (\SoapFault $e) {
