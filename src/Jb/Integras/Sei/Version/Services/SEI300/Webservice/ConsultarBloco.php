...
class ConsultarBloco extends IntegrasSEI300 implements IntegrasServiceInterface, ExtractInterface
{
    ...
    private $sinRetornarProtocolos = null;
    ...
    private function loadParameters(array $args)
    {
        ...
        if (!isset($args[2])) {
            IntegrasServicesArgumentException::argumentRequired('sinRetornarProtocolos');
        }

        $this->idUnidade = isset($args[0]) ? $args[0] : null;
        $this->idBloco = isset($args[1]) ? $args[1] : null;
        $this->sinRetornarProtocolos = isset($args[2]) ? $args[2] : null;
    }
        ...
        try {
            return $this->resource->__soapCall(
                ...
                array(
                    ...
                    'SinRetornarProtocolos' => $this->sinRetornarProtocolos
                )
            );
        } catch (\SoapFault $e) {
