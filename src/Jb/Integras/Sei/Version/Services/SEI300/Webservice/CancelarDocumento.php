...
class CancelarDocumento extends IntegrasSEI300 implements IntegrasServiceInterface, ExtractInterface
{
    ...
    private function loadParameters(array $args)
    {
        ...
        $this->protocoloDocumento = isset($args[1]) ? $args[1] : null;
        $this->motivo = isset($args[2]) ? $args[2] : null;
    }
