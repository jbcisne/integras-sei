...
class AtualizarContatos extends IntegrasSEI300 implements IntegrasServiceInterface, ExtractInterface
{

    private $idUnidade = null;

    private $contatos = null;
    ...
    private function loadParameters(array $args)
    {
        ...
        if (!isset($args[1])) {
            IntegrasServicesArgumentException::argumentRequired('contatos');
        }

        $this->idUnidade = isset($args[0]) ? $args[0] : null;
        $this->contatos = isset($args[1]) ? $args[1] : null;
    }
