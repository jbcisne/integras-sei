...
class IncluirDocumentoBloco extends IntegrasSEI300 implements IntegrasServiceInterface, ExtractInterface
{
    ...
    private function loadParameters(array $args)
    {
        ...
        $this->protocoloDocumento = isset($args[2]) ? $args[2] : null;
