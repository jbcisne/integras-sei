...
class ListarCargos extends IntegrasSEI300 implements IntegrasServiceInterface, ExtractInterface
{
    ...
    private function loadParameters(array $args)
    {
        ...
        if (!isset($args[1])) {
            IntegrasServicesArgumentException::argumentRequired('idCargo');
        }

        $this->idUnidade = isset($args[0]) ? $args[0] : null;
        $this->idCargo = isset($args[1]) ? $args[1] : null;
    }
