...
/**
 * Serviço de Atribuição de Processo no SEI versão 2.6.0
 *
 * @author Juliano Buzanello <jbcisne@gmail.com>
 * @version 0.0.1
 * */
class AtribuirProcesso extends IntegrasSEI260 implements IntegrasServiceInterface, ExtractInterface
{
    /**
     * @var string
     */
    ...
    /**
     * efetua a execução do serviço para atribuição de processo
     *
     * @return integer
