...
/**
 * Integrador SEI versão 3.0.0
 *
 * @author Juliano Buzanello <jbcisne@gmail.com>
 * @version 0.0.1
 * */
class IntegrasSEI300 extends IntegrasSEI
{
    ...
    private function connectorWebservice()
    {
        ...
        try {
            ...
            if (isset($WSConfig['endpoint']) && !empty($WSConfig['endpoint'])) {
                $this->resource->__setLocation($WSConfig['endpoint']);
            }
        } catch (\Exception $e) {
    ...
    protected function getWsdlMethodCalledName()
    {
